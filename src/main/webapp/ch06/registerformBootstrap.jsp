...
<body class="bg-light">
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    <div class="container-fluid">
      <img src="/jw/ck-logo.png" height="60">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="mt-3 mb-3">
              ...
              <span>
                <a class="ms-2" href="#"><img src="jw/google-logo (1).png" height="32"></a>
                <a class="ms-2" href="#"><img src="jw/github-logo (1).png" height="32"></a>
                <a class="ms-2" href="#"><img src="jw/naver-logo (1).jpg" height="32"></a>
                <a class="ms-2" href="#"><img src="jw/kakao-logo (1).png" height="32"></a>
              </span>
            </div>
          </div>
        </div>
