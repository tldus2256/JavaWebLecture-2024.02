...
<body style="margin: 50px; margin-bottom:100px">
        ...
        <table border="1">
                ...
                <tr><td>\${10 ge 8 and 4 le 3}</td><td>${10 gt 8 and 4 le 3}</td></tr>
                <tr><td>\${!(10 ge 8 and 4 le 3)}</td><td>${!(10 gt 8 and 4 le 3)}</td></tr>
                <tr><td>\${not(10 ge 8 and 4 le 3)}</td><td>${not(10 gt 8 and 4 le 3)}</td></tr>
                <tr><td>\${10 lt 8 or 4 gt 3}</td><td>${10 le 8 or 4 gt 3}</td></tr>
