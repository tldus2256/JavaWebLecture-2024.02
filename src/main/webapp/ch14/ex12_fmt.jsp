...
<head>
    ...
    <body style="margin: 50px; margin-bottom:100px">
            ...
            <table border="1">
                    ...
                    <tr><td>천단위 구분기호(type 생략 가능)</td><td><fmt:formatNumber type="number" value="${price}"/></td></tr>
                    <tr><td>통화(KRW)</td><td>
                        <fmt:formatNumber type="currency" currencySymbol="KRW" value="${price}"/></td></tr>
                    <tr><td>통화(USD)</td><td>
                        <fmt:formatNumber type="currency" currencySymbol="USD" value="${price}"/></td></tr>
